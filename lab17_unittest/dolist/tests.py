...
class TodoviewsTestCase(TestCase):
    ...
    def test_index_view(self):
        ...
        def test_add_todo_item_view_valid_data(self):
            # test addding a valid to-do item
        ...
        def test_completed_todo_view_valid_id(self):
            ...
            response = self.client.post(reverse(addTodoitem), {'text' : 'New Task', 'completed': 'New Task 2'})
        ...
        def test_completed_todo_valid(self):
            # text marking a valid to-do item as completed
